...
describe('TDatePicker', () => {
    ...
    describe('Props', () => {
        ...
        it.each(invalidMonths)(
            'Displays correctly when incorrect value is provided to month type root: #%s',
            (invalidDate) => {
                // Arrange
        ...
        it.each(invalidYears)(
            'Displays correctly when incorrect value is provided to year type root. data: #%s',
            (invalidDate) => {
                // Arrange
    ...
    describe('Event', () => {
        ...
        it('When user opens the date calendar and clicks next Month or prev Month or Today Button, the date changes normally.', async () => {
            // Arrange
            const user = userEvent.setup();
        ...
        it(
            ...
            async () => {
                ...
                const TestDatePicker = () => {
                    ...
                    return <TDatePicker valueType={'date'} value={dateInput} onChange={setDateInput} />;
                };
                render(<TestDatePicker />);
        ...
        it(
            ...
            async () => {
                ...
                const TestDatePicker = () => {
                    ...
                    return <TDatePicker valueType={'month'} value={value} onChange={setValue} />;
                };
                ...
                // Assert
                expect(selectedMonthRoot).toHaveClass(
