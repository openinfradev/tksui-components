...
describe('TBadge', () => {
    describe('Style', () => {
        it('Classname prop applies to root', () => {
            ...
            render(
                <TBadge content={1} className={testData}>
                    icon
                </TBadge>
            );
        ...
        it('Style prop applies to root', () => {
            ...
            render(
                <TBadge content={1} style={testData}>
                    icon
                </TBadge>
            );
        ...
        it('Color props applies to badge', () => {
            ...
            render(
                <TBadge content={1} color={testData}>
                    icon
                </TBadge>
            );
    ...
    describe('Content', () => {
        ...
        it('When content prop is greater than max prop, it should be displayed on content area', () => {
            ...
            render(
                <TBadge content={testData} max={maximum}>
                    icon
                </TBadge>
            );
