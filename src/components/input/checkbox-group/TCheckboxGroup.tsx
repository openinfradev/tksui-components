...
import type {TCheckboxGroupProps, TCheckboxGroupValue, TCheckboxValue} from '@/components';
...
const TCheckboxGroup = ({
    ...
    const props: TCheckboxGroupProps = {textKey, valueKey, lazy, onChange, ref, ...restProps};
