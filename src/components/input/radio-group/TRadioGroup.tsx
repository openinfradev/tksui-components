...
import type {TRadioGroupProps, TRadioGroupValue, TRadioValue} from '@/components';
import TRadio from '../radio/TRadio';

const TRadioGroup = ({textKey = 'text', valueKey = 'value', lazy = true, ref, ...restProps}: TRadioGroupProps) => {
    // region [Hooks]
