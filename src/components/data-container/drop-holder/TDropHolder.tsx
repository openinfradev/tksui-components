...
import type {DropHolderAlignment, TDropHolderItem, TDropHolderProps} from '@/components';
...
const TDropHolder = ({
    ...
    const props: TDropHolderProps = {alignment, textKey, offset, itemTemplate, ref, ...restProps};
