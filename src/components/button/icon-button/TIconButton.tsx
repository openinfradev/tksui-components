...
import type {TIconButtonProps, TIconButtonRef} from '@/components';
import {TIcon} from '@/components';

import themeToken from '~style/designToken/ThemeToken.module.scss';

const TIconButton = forwardRef(
    ({shape = 'circle', outline = 'elevation', onClick, ...restProps}: TIconButtonProps, ref: Ref<TIconButtonRef>) => {
        // region [Hooks]
        ...
        return (
            ...
            >
                <TIcon
                    className={'t-icon-button__inner'}
                    small
