...
import type {TDropdownProps} from '@/components/input/dropdown/TDropdown.interface';
                ...
                <div>
                    ...
                    <div style={containerStyle}>
                        ...
                        <TDropdown
                            {...args}
                            {...singleSelect6}
                            itemTemplate={(item) => `${item.text} (${item.koreanText})`}
                        />
                ...
                <div>
                    ...
                    <div style={containerStyle}>
                        ...
                        <TDropdown
                            ...
                            {...multiSelect4}
                            multiple
                            filterPlaceholder={'좋아하는 과일들을 선택해주세요'}
                            textKey={'koreanText'}
                        />
