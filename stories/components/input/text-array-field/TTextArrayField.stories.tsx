...
import type {TTextArrayFieldProps, TTextArrayFieldRef} from '~/input/text-array-field';
import {TTextArrayField} from '~/input/text-array-field';
    ...
    return (
        <>
            <div style={{display: 'flex', flexDirection: 'column', gap: '24px'}}>
                <TButton main width={'80px'} onClick={validateChildren}>
                    검사
                </TButton>
